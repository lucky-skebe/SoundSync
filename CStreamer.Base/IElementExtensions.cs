...
namespace CStreamer.Base
{
    ...
    public static class IElementExtensions
    {
        ...
        /// <summary>
        /// Returns ann CStreamer Properties of a given Element.
        /// </summary>
        /// <remarks>
        /// For a .Net Property to be recognized it needs the <see cref="PropertyAttribute"/> and an axxessible getter and setter.
        /// </remarks>
        /// <param name="element">The element.</param>
        /// <returns>All the CStreamer Properties.</returns>
        public static IEnumerable<PropertyInfo> GetProperties(this IElement element)
        {
            return element.GetType().GetProperties().Where(prop => prop.GetCustomAttribute<PropertyAttribute>() != null && prop.CanRead && prop.CanWrite);
        }
